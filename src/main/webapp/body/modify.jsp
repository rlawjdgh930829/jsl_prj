...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#summernote').summernote('code', "${ ITEM.product_content }");
...
<div class="container">
	  <h2>글 등록</h2>
	  <form:form modelAttribute="product" class="form-horizontal" action="../product/modify.html" method="post" enctype="multipart/form-data">
	  	<form:hidden path="product_no" value="${ ITEM.product_no }"/>
	  	<div class="form-group">
	      <label class="control-label col-sm-2" for="title">제목:</label>
	      <div class="col-sm-10">
	        <form:input type="text" path="product_title" class="form-control" id="title" placeholder="Title" name="title" value="${ ITEM.product_title }"/>
	    ...
	    <div class="form-group">
	      ...
	      <div class="col-sm-10">
	        <input type="text" class="form-control" id="price1" placeholder="Price" name="price1" value="${ ITEM.product_price }"/>
	        <form:input type="hidden" path="product_price" class="form-control" id="price2" name="price2" value="${ ITEM.product_price }"/>
